...
אם אינכם מצליחים לנסח 5 שאלות, אפשר לנסח 4 שאלות, או 3 (מינימום), אבל השתדלו לנסח 5.
  ...
  <li>2 שאלות <b>רלוונטיות</b> לפסקה, אך שאין להן תשובה בפסקה.
  ...
  <b><a href="https://drive.google.com/file/d/1RmY3YzA8QfPmBnW_FKhU4t0jTw5P4472/view?usp=sharing" target="_blank" v-on:click="guideClicked" v-on:auxclick="guideClicked"
   > ההנחיות</a></b>.
    </h5> 
