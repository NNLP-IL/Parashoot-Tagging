<template>
  <div class="HomePage container mt-3 mb-3"  dir = "rtl" align = "right">
    ...
    <div v-else>
      ...
      <hr>
  <p style="border:3px; border-style:solid; border-color:#FF0000; padding: 1em;">המשימה הזו היא הראשונה בסדרה של משימות רבות. אם עבודתך תהיה טובה ותענה על הנדרש בהנחיות, תקבל/י הזמנה להשתתף במשימות הבאות.</p>
  <p>
